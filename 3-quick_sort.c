 ...
 * @left: The initial index of the subset to order.
 * @right: The final index of the subset to order.
 *
 ...
 * @size: The size of the array.
 * @left: The initial index of the array partition to order.
 * @right: The final index of the array partition to order.
 *
